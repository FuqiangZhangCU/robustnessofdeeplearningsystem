...
from testmodels.setup_mnist import MNIST
from testmodels.setup_cifar import CIFAR
import os
...
train(CIFAR(), "inputs/model/cifar", [64, 64, 128, 128, 256, 256], num_epochs=50)
train(MNIST(), "inputs/model/mnist", [32, 32, 64, 64, 200, 200], num_epochs=50)

train_distillation(MNIST(), "inputs/model/mnist-distilled-100", [32, 32, 64, 64, 200, 200],
                   num_epochs=50, train_temp=100)
train_distillation(CIFAR(), "inputs/model/cifar-distilled-100", [64, 64, 128, 128, 256, 256],
                   num_epochs=50, train_temp=100)
